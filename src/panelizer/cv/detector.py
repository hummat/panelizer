...
from .confidence import compute_page_confidence, compute_panel_confidence
from .pipeline import actual_gutters, detect_panels
...
class CVDetector:
    ...
    def detect(self, image: Image.Image, *, debug: Optional["DebugContext"] = None) -> DetectionResult:
        ...
        # Compute per-panel confidence scores
        panel_confidences = []
        ...
        confidence = compute_page_confidence(panel_confidences, panel_areas, page_area)
