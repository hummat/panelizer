...
class Page(BaseModel):
    ...
    gutters: Optional[Tuple[int, int]] = Field(default=None, description="[x_gutter, y_gutter] in pixels")
    processing_time: Optional[float] = Field(default=None, description="Detection time in seconds")
